...
class LocalidadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create localidad" do
    assert_difference('Localidad.count') do
      post localidads_url, params: { localidad: { nombre: @localidad.nombre, provincia_id: @localidad.provincia_id } }, as: :json
    end
  ...
  test "should update localidad" do
    patch localidad_url(@localidad), params: { localidad: { nombre: @localidad.nombre, provincia_id: @localidad.provincia_id } }, as: :json
    assert_response 200
  end
